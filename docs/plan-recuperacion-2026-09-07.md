...
- Manifiesto móvil: se crea el enlace cuando el HTML base no lo incluye; DOM en Chrome confirma nombre y URL de manifiesto propios después de recarga. La evidencia de735pruebas de Sol en TDD se rotula histórica para evitar atribuirla a este SHA; trazabilidad8passed.
