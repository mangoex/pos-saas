...
interface OrderDetail extends OrderAccount {
  ...
  lines: Array<{
    ...
    selected_modifiers?: Array<{ name: string; price_cents?: number; text?: string; [key: string]: any }>;
  }>;
