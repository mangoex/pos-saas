...
organizations = sa.Table(
    ...
    sa.Column("menu_home_image_url", sa.Text(), nullable=True),
...
branches = sa.Table(
    ...
    sa.Column("bank_transfer_info", sa.JSON(), nullable=False, server_default="{}"),
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
...
orders = sa.Table(
    ...
    sa.CheckConstraint(
        "discount_cents >= 0",
        name="ck_orders_discount_cents_non_negative",
    ),
    sa.CheckConstraint(
...
public_order_intents = sa.Table(
    ...
    sa.CheckConstraint(
        "total_cents >= 0 AND delivery_fee_cents >= 0 AND discount_cents >= 0 AND version > 0",
